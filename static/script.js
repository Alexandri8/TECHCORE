// script.js - TechCore interactions and form handling consolidated and optimized
// Optimization: Removed 4 redundant mobile menu implementations, reducing file size and listener overhead.
// Optimization: Enabled unobserve on IntersectionObserver to reduce runtime memory and CPU usage.
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const observer = new IntersectionObserver((entries, observer) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                // Optimization: stop observing once animated to avoid re-triggering and reduce overhead
    ...
    // 4. Mobile Menu Toggle - Consolidated Implementation
    ...
    if (mobileBtn && navLinks) {
        ...
        // Close menu when a link is clicked or on backdrop click
    ...
    // 5. Global Key Listeners (Escape key)
    ...
    // 6. Form Handlers and Modal Triggers
    const contactForm = document.getElementById("contactForm");
    if (contactForm) contactForm.addEventListener("submit", (e) => { e.preventDefault(); sendMessage(); });
